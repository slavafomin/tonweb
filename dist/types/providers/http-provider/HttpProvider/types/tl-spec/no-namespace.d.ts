...
export declare type AccountState = Raw.AccountState | Wallet.V3.AccountState | Wallet.Highload.V1.AccountState | Wallet.Highload.V2.AccountState | Dns.AccountState | Rwallet.AccountState | Pchan.AccountState | Uninited.AccountState;
