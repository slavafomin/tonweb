...
export declare namespace Tvm {
    ...
    export type StackEntry = Tvm.StackEntrySlice | Tvm.StackEntryCell | Tvm.StackEntryNumber | Tvm.StackEntryTuple | Tvm.StackEntryList | Tvm.StackEntryUnsupported;
    export {};
}
